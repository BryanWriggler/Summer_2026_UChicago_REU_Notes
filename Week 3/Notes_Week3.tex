...
\begin{exmp}
    ...
    The unit morphism is identified by the adjunction $\Hom_\mathcal{V}(*\times v,v)\cong \Hom_\mathcal{V}(*,\mathcal{V}(v,v))$, identified as the image of the natural isomorphism 
\end{exmp}
