...
\begin{defn}
    Given an operad $\mathcal{C}$ over a symmetric monoidal category $\mathcal{V}$, a \emph{$\mathcal{C}$-algebra} is an object $X\in\mathcal{V}$, with collections of morphisms $\theta:\mathcal{C}(j)\tensor X^j\rightarrow X$, that satisfies the following axioms:
    \begin{itemize}
...
\begin{exmp}
    A $\mathcal{N}$-algebra $A\in\mathcal{V}$ is a \emph{commutative monoid} in the symmetric monoidal category: It has a product morphism $\theta:\mathcal{N}(2)\tensor A^2\cong A\tensor A\rightarrow A$, and a unit morphism $\theta\circ \eta:A\cong \kappa\tensor A\xrightarrow{\sim}\mathcal{N}(1)\tensor A\xrightarrow{\sim} A$.
    \begin{itemize}
