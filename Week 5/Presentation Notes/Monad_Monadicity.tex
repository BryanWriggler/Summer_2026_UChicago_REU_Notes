...
\section{Monad Algebra and Monadicity (ND)}
...
With these definitions, let's consider the case for Eilenberg-Moore category, the functor $G^T:\mathcal{C}^T\rightarrow\mathcal{C}$:
\begin{prop}
    The forgetful functor $G^T$ for Eilenberg-Moore category strictly creates $G^T$-split coequalizers.
\end{prop}
\begin{proof}
